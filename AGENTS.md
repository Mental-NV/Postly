...
## Active Technologies
- SQLite via EF Core migrations; persisted session records; additional Round 2 persistence for avatar state, reply relationships, and notifications (002-profile-replies-notifications)
